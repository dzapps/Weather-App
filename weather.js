...
function getWeather(){
    ...
    if(city != ''){
        ...
        $.ajax({
           url: 'http://api.openweathermap.org/data/2.5/weather?q=' + city + "&units=metric" + "&appid=7afc8e83d5d5997cbd51c044bc6c0c28",
            type: "GET",
            dataType: "json",
        ...
        $("#error").html("<div class='alert alert-danger' id='errorCity'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Sorry! You need to enter a city.</div>");
    }
